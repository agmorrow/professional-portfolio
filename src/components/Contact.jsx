...
const Contact = () => {
  return (
    <div name='contact' className='w-full bg-slate-200 flex justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/54764d0b-d7a4-4e61-8f8c-9b47362b0ae9" className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='text-black border-2 bg-amber-400 hover:bg-amber-400 hover:border-amber-400 px-16 py-3 my-8 mx-auto flex items-center'>Send</button>
      </form>
    </div>
  )
}
